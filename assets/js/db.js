  ...
  const categs = [
    {
      name: 'world',
      img: '7605.jpg',
      caption: 'Latest stories and updates from around the world'
    },
    {
      name: 'climate',
      img: 'cl.jpg',
      caption:'Updates on our planet, environment, and climate action'
    },
    {
      name: 'kenya',
      img: 'kenya.jpg',
      caption: 'Breaking news, hot trends and gossip topics from the place to be, Kenya!'
    },
    {
      name:'people',
      img:'j1.jpg',
      caption: 'Latest stories and updates about people'
    },
    {
      name: 'health',
      img: 'h5363.jpg',
      caption : 'Wellness tips, medical news, and healthy life vibes'
    },
    {
      name: 'business',
      img: 'business.jpeg',
      caption: 'Market moves, money talk, and big company updates'
    },
    {
      name: 'entertainment',
      img: 'ent.jpg',
      caption : 'Trending drama, movies, music, and celeb buzz'
    },
    {
      name: 'sports',
      img: 'ft.jpg',
      caption: 'Scores, highlights, and top moments in sports'

    },
    {
      name: 'politics',
      img: 'pl.webp',
      caption : 'Key decisions, policy talk, and leadership news'
    }
  ]
  
  window.categs = categs
  const countries = [
    ...
    { name: "Myanmar (Burma)", code: "MM", continent: "Asia" },
